...
componentWillMount() {
    ...
    handleLineUpdate(index, record) {
        ...
        router.push({pathname:'/page/edit',query: {...that.props.query,pageId:record.id}});
    ...
    handleLineDetail(record) {
        ...
        //this.context.router.push({pathname:'//page/detail',state:{item:record}});
        router.push({pathname:'/page/detail',query:{...that.props.query,pageId:record.id}});
    ...
    handleLineAdd() {
        let that = this;
        //this.context.router.push({pathname:'//page/add'});
        router.push({pathname:'/page/add',query:{...that.props.query}});
    }

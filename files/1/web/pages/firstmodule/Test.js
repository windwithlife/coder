...
//import model from './models/model.js';ttt
...
export default class DetailPage extends React.Component {
   ...
   composeResultData(response,data){
        this.results[response] = data;
   }
   fetchData=()=>{
      
      tablecccc.firstinterface(firstinterfaceInputParam).then(this.composeResultData.bind(this,"firstinterfaceResponse"))

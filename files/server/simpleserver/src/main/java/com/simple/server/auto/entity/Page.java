...
public class Page implements Serializable {
    ...
    private Long myInterface;
        

    private Long commonInterface;
    ...
    public Long getMyInterface(){
         return this.myInterface;
    };
    public void setMyInterface(Long myInterface){
    ...
    public Long getCommonInterface(){
         return this.commonInterface;
    };
    public void setCommonInterface(Long commonInterface){

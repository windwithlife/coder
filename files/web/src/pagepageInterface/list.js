...
componentWillMount() {
    ...
    handleLineUpdate(index, record) {
        ...
        router.push({pathname:'/pagepageinterface/edit',query: {...that.props.query,pagepageinterfaceId:record.id}});
    ...
    handleLineDetail(record) {
        ...
        //this.context.router.push({pathname:'//pagepageinterface/detail',state:{item:record}});
        router.push({pathname:'/pagepageinterface/detail',query:{...that.props.query,pagepageinterfaceId:record.id}});
    ...
    handleLineAdd() {
        let that = this;
        //this.context.router.push({pathname:'//pagepageinterface/add'});
        router.push({pathname:'/pagepageinterface/add',query:{...that.props.query}});
    }

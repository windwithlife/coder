...
class EditForm extends React.Component {
    ...
    componentWillMount(){
        ...
        var that = this;
        console.log("edit id:=" + this.props.query.pxpageid);
        model.queryById(this.props.query.pxpageId,function(response) {
    ...
    handleSaveAndEdit(childModuleName,data) {
        ...
        let that = this;
        let params = {...that.props.query,fromModule:'pxpage'};
    ...
    onAssociationEdit(aName,referm,e){
        e.preventDefault();
        var that = this;
        var mId = this.props.query.pxpageId;
        let params = {...that.props.query,moduleName:"pxpage",moduleId:mId,associationName:aName,referModule:referm};
        router.push({pathname:'/pxpage/association',query:params});
    }
    handleSubmitUpdate(data) {
        ...
        model.update(data, function(response) {
            if (response && response.data) {
                ...
                router.push({pathname:'/pxpage/list',query:params});
            }
        })
   ...
   // let selectIndex = listItems.sex? listItems.sex:-1;
    ...
    return (
            ...
            <Form  onSubmit={this.handleSubmit.bind(this)}>
                    ...
                    <Form.Item >
                        <XList  onEdit ={that.onAssociationEdit.bind(that,'pxpagexinterface','xinterface')} refer ="pxpagexinterface" mapField="pxpageId" byId={that.props.query.pxpageId}  title="用到公用接口" />
                    </Form.Item>

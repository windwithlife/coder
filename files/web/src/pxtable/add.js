    ...
    handleSubmitUpdate(data) {
        ...
        model.add(data, function(response) {
            if (response && response.data) {
                console.log(data);
                router.push({pathname:'/pxtable/list',query:{...that.props.query}});
            }
        })
...
render()
{
    ...
    return (
            ...
            <Form  onSubmit={this.handleSubmit.bind(this)}>
                ...
                <Form.Item >
                    <XList  onEdit ={that.onSaveAndEdit.bind(that,'pxtablecolumn')} refer ="pxtablecolumn" mapField="tableId" byId='-1'  title="表字段" />
                </Form.Item>

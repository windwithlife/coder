...
class EditForm extends React.Component {
    ...
    handleAssociationEdit(associationModule,referm,data) {
        ...
        model.add(data, function(response) {
            if (response && response.data) {
                console.log(response.data);
                let params = {...that.props.query,moduleName:"xmodule",moduleId:response.data.id,associationName:associationModule,referModule:referm};
...
render()
{
    ...
    return (
            ...
            <Form  onSubmit={this.handleSubmit.bind(this)}>
                ...
                <Form.Item >
                    <XList  onEdit ={that.onAssociationEdit.bind(that,'','project')} refer ="" mapField="xmoduleId" byId='-1'  title="表字段" />
                </Form.Item>
                
                <Form.Item >
                    <XList  onEdit ={that.onAssociationEdit.bind(that,'xmoduletabledefine','project')} refer ="xmoduletabledefine" mapField="xmoduleId" byId='-1'  title="所用表" />
                </Form.Item>

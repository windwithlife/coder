    ...
    return (
            ...
            <Form  onSubmit={this.handleSubmit.bind(this)}>
                ...
                <Form.Item label="所属项目"
                    ...
                    <Form.Item >
                        <XList  onEdit ={that.onAssociationEdit.bind(that,'','page')} refer ="" mapField="xmoduleId" byId={that.props.query.xmoduleId}  title="表字段" />
                    </Form.Item>

                
                    <Form.Item >
                        <XList  onEdit ={that.onAssociationEdit.bind(that,'xmoduletabledefine','tabledefine')} refer ="xmoduletabledefine" mapField="xmoduleId" byId={that.props.query.xmoduleId}  title="所用表" />
                    </Form.Item>

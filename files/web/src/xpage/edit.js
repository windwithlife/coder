...
class EditForm extends React.Component {
    ...
    componentWillMount(){
        ...
        var that = this;
        console.log("edit id:=" + this.props.query.xpageid);
    ...
    handleSaveAndEdit(childModuleName,data) {
        ...
        let that = this;
        let params = {...that.props.query,fromModule:'xpage'};
    ...
    onAssociationEdit(aName,referm,e){
        e.preventDefault();
        var that = this;
        var mId = this.props.query.xpageId;
        let params = {...that.props.query,moduleName:"xpage",moduleId:mId,associationName:aName,referModule:referm};
        router.push({pathname:'/xpage/association',query:params});
    }
    handleSubmitUpdate(data) {
        ...
        model.update(data, function(response) {
            if (response && response.data) {
                ...
                router.push({pathname:'/xpage/list',query:params});
            }
        })
   ...
   // let selectIndex = listItems.sex? listItems.sex:-1;
    ...
    return (
            ...
            <Form  onSubmit={this.handleSubmit.bind(this)}>
                    ...
                    <Form.Item >
                        <XList  onEdit ={that.onAssociationEdit.bind(that,'xpagepageinterface','pageinterface')} refer ="xpagepageinterface" mapField="xpageId" byId={that.props.query.xpageId}  title="用到公用接口" />
                    </Form.Item>

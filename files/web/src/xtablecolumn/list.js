...
class ListExample extends React.Component{
    ...
    onFooterBack(){
        ...
        router.replace({pathname:"/xtable/edit" ,query:this.props.query});
...
componentWillMount() {
    ...
    handleLineUpdate(index, record) {
        ...
        router.push({pathname:'/xtablecolumn/edit',query: {...that.props.query,xtablecolumnId:record.id}});
    ...
    handleLineDetail(record) {
        ...
        //this.context.router.push({pathname:'//xtablecolumn/detail',state:{item:record}});
        router.push({pathname:'/xtablecolumn/detail',query:{...that.props.query,xtablecolumnId:record.id}});
    ...
    handleLineAdd() {
        let that = this;
        //this.context.router.push({pathname:'//xtablecolumn/add'});
        router.push({pathname:'/xtablecolumn/add',query:{...that.props.query}});
    }

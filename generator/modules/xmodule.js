...
module.exports  =
{
    ...
    fields: {
        ...
        pages: {type: 'Long', dName: "表字段", show:'M2MList', refer: {module:"xpage",map:"OneToMany",mapField:"pageId"}},
        mytables: {type: 'Long', dName: "所用表", show:'M2Mlist', refer: {module:'xtable',map:"ManyToMany"}},

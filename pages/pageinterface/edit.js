...
class EditForm extends React.Component {
    ...
    componentWillMount(){
        ...
        var that = this;
        console.log("edit id:=" + this.props.query.pageinterfaceid);
        model.queryById(this.props.query.pageinterfaceId,function(response) {
    ...
    handleSaveAndEdit(childModuleName,data) {
        ...
        let that = this;
        let params = {...that.props.query,fromModule:'pageinterface'};
    ...
    onAssociationEdit(aName,referm,e){
        e.preventDefault();
        var that = this;
        var mId = this.props.query.pageinterfaceId;
        let params = {...that.props.query,moduleName:"pageinterface",moduleId:mId,associationName:aName,referModule:referm};
        router.push({pathname:'/pageinterface/association',query:params});
    }
    handleSubmitUpdate(data) {
        ...
        model.update(data, function(response) {
            if (response && response.data) {
                ...
                router.push({pathname:'/pageinterface/list',query:params});
            }
        })

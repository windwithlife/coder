...
componentWillMount() {
    ...
    handleLineUpdate(index, record) {
        ...
        router.push({pathname:'/pageinterface/edit',query: {...that.props.query,pageinterfaceId:record.id}});
    ...
    handleLineDetail(record) {
        ...
        //this.context.router.push({pathname:'//pageinterface/detail',state:{item:record}});
        router.push({pathname:'/pageinterface/detail',query:{...that.props.query,pageinterfaceId:record.id}});
    ...
    handleLineAdd() {
        let that = this;
        //this.context.router.push({pathname:'//pageinterface/add'});
        router.push({pathname:'/pageinterface/add',query:{...that.props.query}});
    }

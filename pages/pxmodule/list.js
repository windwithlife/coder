...
componentWillMount() {
    ...
    handleLineUpdate(index, record) {
        ...
        router.push({pathname:'/pxmodule/edit',query: {...that.props.query,pxmoduleId:record.id}});
    ...
    handleLineDetail(record) {
        ...
        //this.context.router.push({pathname:'//pxmodule/detail',state:{item:record}});
        router.push({pathname:'/pxmodule/detail',query:{...that.props.query,pxmoduleId:record.id}});
    ...
    handleLineAdd() {
        let that = this;
        //this.context.router.push({pathname:'//pxmodule/add'});
        router.push({pathname:'/pxmodule/add',query:{...that.props.query}});
    }

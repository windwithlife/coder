...
class EditForm extends React.Component {
    ...
    componentWillMount(){
        ...
        var that = this;
        console.log("edit id:=" + this.props.query.pxtableid);
   ...
   // let selectIndex = listItems.sex? listItems.sex:-1;
    ...
    return (
            ...
            <Form  onSubmit={this.handleSubmit.bind(this)}>
                    ...
                    <Form.Item >
                        <XList  onEdit ={that.onSaveAndEdit.bind(that,"pxtablecolumn")} refer ="pxtablecolumn" mapField="tableId" byId={that.props.query.pxtableId}  title="表字段" />
                        </Form.Item>

...
class EditForm extends React.Component {
    ...
    componentWillMount(){
        ...
        var that = this;
        console.log("edit id:=" + this.props.query.xtablecolumnid);
    ...
    handleSaveAndEdit(childModuleName,data) {
        ...
        let that = this;
        let params = {...that.props.query,fromModule:'xtablecolumn'};
    ...
    onAssociationEdit(aName,referm,e){
        e.preventDefault();
        var that = this;
        var mId = this.props.query.xtablecolumnId;
        let params = {...that.props.query,moduleName:"xtablecolumn",moduleId:mId,associationName:aName,referModule:referm};
    ...
    handleSubmitUpdate(data) {
        ...
        model.update(data, function(response) {
            if (response && response.data) {
                ...
                router.push({pathname:'/xtablecolumn/list',query:params});
            }
        })

...
componentWillMount() {
    ...
    handleLineUpdate(index, record) {
        ...
        router.push({pathname:'/xinterface/edit',query: {...that.props.query,xinterfaceId:record.id}});
    ...
    handleLineDetail(record) {
        ...
        //this.context.router.push({pathname:'//xinterface/detail',state:{item:record}});
        router.push({pathname:'/xinterface/detail',query:{...that.props.query,xinterfaceId:record.id}});
    ...
    handleLineAdd() {
        let that = this;
        //this.context.router.push({pathname:'//xinterface/add'});
        router.push({pathname:'/xinterface/add',query:{...that.props.query}});
    }

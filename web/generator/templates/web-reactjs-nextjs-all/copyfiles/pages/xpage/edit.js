   ...
   // let selectIndex = listItems.sex? listItems.sex:-1;
    ...
    return (
            ...
            <Form  onSubmit={this.handleSubmit.bind(this)}>
                    ...
                    <Form.Item >
                        <XList  onEdit ={that.onAssociationEdit.bind(that,'xpagexinterface','xinterface')} refer ="xpagexinterface" mapField="xpageId" byId={that.props.query.xpageId}  title="用到公用接口" />
                    </Form.Item>

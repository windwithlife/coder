...
class EditForm extends React.Component {
    ...
    componentWillMount(){
        ...
        var that = this;
        console.log("edit id:=" + this.props.query.dictionaryid);
        model.queryById(this.props.query.dictionaryId,function(response) {
    ...
    handleSaveAndEdit(childModuleName,data) {
        ...
        let that = this;
        let params = {...that.props.query,fromModule:'dictionary'};
    ...
    onAssociationEdit(aName,referm,e){
        e.preventDefault();
        var that = this;
        var mId = this.props.query.dictionaryId;
        let params = {...that.props.query,moduleName:"dictionary",moduleId:mId,associationName:aName,referModule:referm};
    ...
    handleSubmitUpdate(data) {
        ...
        model.update(data, function(response) {
            if (response && response.data) {
                ...
                router.push({pathname:'/dictionary/list',query:params});
            }
        })
            ...
            <Form  onSubmit={this.handleSubmit.bind(this)}>
                ...
                <Form.Item label="字典类别"
                    ...
                    getFieldDecorator("category", {
                        initialValue: listItems.category,
                    })(

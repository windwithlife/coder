...
class EditForm extends React.Component {
    ...
    componentWillMount(){
        ...
        var that = this;
        console.log("edit id:=" + this.props.query.pxchannelid);
        model.queryById(this.props.query.pxchannelId,function(response) {
    ...
    handleSaveAndEdit(childModuleName,data) {
        ...
        let that = this;
        let params = {...that.props.query,fromModule:'pxchannel'};
    ...
    onAssociationEdit(aName,referm,e){
        e.preventDefault();
        var that = this;
        var mId = this.props.query.pxchannelId;
        let params = {...that.props.query,moduleName:"pxchannel",moduleId:mId,associationName:aName,referModule:referm};
    ...
    handleSubmitUpdate(data) {
        ...
        model.update(data, function(response) {
            if (response && response.data) {
                ...
                router.push({pathname:'/pxchannel/list',query:params});
            }
        })
   ...
   // let selectIndex = listItems.sex? listItems.sex:-1;
    ...
    return (
            ...
            <Form  onSubmit={this.handleSubmit.bind(this)}>
                    ...
                    <Form.Item >
                        <XList  onEdit ={that.onAssociationEdit.bind(that,'','xmodule')} refer ="" mapField="pxchannelId" byId={that.props.query.pxchannelId}  title="表字段" />
                    </Form.Item>

...
componentWillMount() {
    ...
    handleLineUpdate(index, record) {
        ...
        router.push({pathname:'/pxchannel/edit',query: {...that.props.query,pxchannelId:record.id}});
    ...
    handleLineDetail(record) {
        ...
        //this.context.router.push({pathname:'//pxchannel/detail',state:{item:record}});
        router.push({pathname:'/pxchannel/detail',query:{...that.props.query,pxchannelId:record.id}});
    ...
    handleLineAdd() {
        let that = this;
        //this.context.router.push({pathname:'//pxchannel/add'});
        router.push({pathname:'/pxchannel/add',query:{...that.props.query}});
    }

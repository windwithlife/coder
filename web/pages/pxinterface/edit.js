...
class EditForm extends React.Component {
    ...
    componentWillMount(){
        ...
        var that = this;
        console.log("edit id:=" + this.props.query.pxinterfaceid);
        model.queryById(this.props.query.pxinterfaceId,function(response) {
    ...
    handleSaveAndEdit(childModuleName,data) {
        ...
        let that = this;
        let params = {...that.props.query,fromModule:'pxinterface'};
    ...
    onAssociationEdit(aName,referm,e){
        e.preventDefault();
        var that = this;
        var mId = this.props.query.pxinterfaceId;
        let params = {...that.props.query,moduleName:"pxinterface",moduleId:mId,associationName:aName,referModule:referm};
        router.push({pathname:'/pxinterface/association',query:params});
    }
    handleSubmitUpdate(data) {
        ...
        model.update(data, function(response) {
            if (response && response.data) {
                ...
                router.push({pathname:'/pxinterface/list',query:params});
            }
        })

...
componentWillMount() {
    ...
    handleLineUpdate(index, record) {
        ...
        router.push({pathname:'/pxinterface/edit',query: {...that.props.query,pxinterfaceId:record.id}});
    ...
    handleLineDetail(record) {
        ...
        //this.context.router.push({pathname:'//pxinterface/detail',state:{item:record}});
        router.push({pathname:'/pxinterface/detail',query:{...that.props.query,pxinterfaceId:record.id}});
    ...
    handleLineAdd() {
        let that = this;
        //this.context.router.push({pathname:'//pxinterface/add'});
        router.push({pathname:'/pxinterface/add',query:{...that.props.query}});
    }

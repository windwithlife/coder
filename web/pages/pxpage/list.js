...
componentWillMount() {
    ...
    handleLineUpdate(index, record) {
        ...
        router.push({pathname:'/pxpage/edit',query: {...that.props.query,pxpageId:record.id}});
    ...
    handleLineDetail(record) {
        ...
        //this.context.router.push({pathname:'//pxpage/detail',state:{item:record}});
        router.push({pathname:'/pxpage/detail',query:{...that.props.query,pxpageId:record.id}});
    ...
    handleLineAdd() {
        let that = this;
        //this.context.router.push({pathname:'//pxpage/add'});
        router.push({pathname:'/pxpage/add',query:{...that.props.query}});
    }

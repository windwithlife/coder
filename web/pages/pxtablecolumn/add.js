...
class EditForm extends React.Component {
    ...
    handleSubmitUpdate(data) {
        ...
        if (this.props.query.pxtableId) {
            data. tableId = this.props.query. pxtableId;
        }
        ...
        model.add(data, function(response) {
            if (response && response.data) {
                console.log(data);
                router.push({pathname:'/pxtablecolumn/list',query:{...that.props.query}});
            }
        })
    ...
    handleSaveAndEdit(childModuleName,data) {
        ...
        model.add(data, function(response) {
                if (response && response.data) {
                    ...
                    let params = {...that.props.query,pxtablecolumnId:response.data.id,fromModule:'pxtablecolumn'};
    ...
    handleAssociationEdit(associationModule,referm,data) {
        ...
        model.add(data, function(response) {
            if (response && response.data) {
                console.log(response.data);
                let params = {...that.props.query,moduleName:"pxtablecolumn",moduleId:response.data.id,associationName:associationModule,referModule:referm};

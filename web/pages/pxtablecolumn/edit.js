...
class EditForm extends React.Component {
    ...
    componentWillMount(){
        ...
        var that = this;
        console.log("edit id:=" + this.props.query.pxtablecolumnid);
        model.queryById(this.props.query.pxtablecolumnId,function(response) {
    ...
    handleSaveAndEdit(childModuleName,data) {
        ...
        let that = this;
        let params = {...that.props.query,fromModule:'pxtablecolumn'};
    ...
    onAssociationEdit(aName,referm,e){
        e.preventDefault();
        var that = this;
        var mId = this.props.query.pxtablecolumnId;
        let params = {...that.props.query,moduleName:"pxtablecolumn",moduleId:mId,associationName:aName,referModule:referm};
        router.push({pathname:'/pxtablecolumn/association',query:params});
    }
    handleSubmitUpdate(data) {
        ...
        model.update(data, function(response) {
            if (response && response.data) {
                ...
                router.push({pathname:'/pxtablecolumn/list',query:params});
            }
        })
            ...
            <Form  onSubmit={this.handleSubmit.bind(this)}>
                ...
                <Form.Item label="所属表"
                    ...
                    getFieldDecorator("tableId", {
                        ...
                        < XSelect  category="" refer ="pxtable" display= {this.props.query.fromModule =='pxtable' ? 'no':'yes'} />
                    )}
                    < /Form.Item>
                        </Card>

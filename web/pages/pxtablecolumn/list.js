...
class ListExample extends React.Component{
    ...
    onFooterBack(){
        ...
        router.replace({pathname:"/pxtable/edit" ,query:this.props.query});
...
componentWillMount() {
    ...
    if(this.props.query.pxtableId){
        model.queryReferListBy("pxtablecolumn","tableId",{id:this.props.query.pxtableId},function(response){
    ...
    handleLineUpdate(index, record) {
        ...
        router.push({pathname:'/pxtablecolumn/edit',query: {...that.props.query,pxtablecolumnId:record.id}});
    ...
    handleLineDetail(record) {
        ...
        //this.context.router.push({pathname:'//pxtablecolumn/detail',state:{item:record}});
        router.push({pathname:'/pxtablecolumn/detail',query:{...that.props.query,pxtablecolumnId:record.id}});
    ...
    handleLineAdd() {
        let that = this;
        //this.context.router.push({pathname:'//pxtablecolumn/add'});
        router.push({pathname:'/pxtablecolumn/add',query:{...that.props.query}});
    }

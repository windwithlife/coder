...
componentWillMount() {
    ...
    handleLineUpdate(index, record) {
        ...
        router.push({pathname:'/xpage/edit',query: {...that.props.query,xpageId:record.id}});
    ...
    handleLineDetail(record) {
        ...
        //this.context.router.push({pathname:'//xpage/detail',state:{item:record}});
        router.push({pathname:'/xpage/detail',query:{...that.props.query,xpageId:record.id}});
    ...
    handleLineAdd() {
        let that = this;
        //this.context.router.push({pathname:'//xpage/add'});
        router.push({pathname:'/xpage/add',query:{...that.props.query}});
    }
